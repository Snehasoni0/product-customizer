  ...
  return (
    ...
    >
      <div className="relative h-[280px] w-full overflow-hidden bg-[#f3f4f6] group-hover:bg-[#ebedef] transition-colors duration-500">
        <div className="absolute inset-0 z-10 transition-all duration-700 group-hover:scale-105 flex items-center justify-center p-8">
          <img 
            src={imageUrl} 
            alt={title} 
      ...
      <div className="flex flex-col p-6 bg-[#0a0a0a] relative z-20">
        ...
        <Link
          href={`/customizer/${id}`}
          className="relative inline-flex items-center justify-center w-full px-5 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-orange-600 rounded-xl hover:bg-gray-200 active:scale-95 text-sm"
        >
